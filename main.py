...
def popup_xml_import_export():
    ...
    if event == 'Export':
        ...
        if export_mapper_file:
            ...
            s_date = sg.popup_get_text(title='Define start date',message='Define the start date (enter numbers only, e.g.: 768)',default_text='0')
            e_date = sg.popup_get_text(title='Define end date',message='Define the end date (enter numbers only, e.g.: 768)',default_text='9999')
