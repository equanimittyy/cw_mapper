...
\
↳ ☑ ~~Create a config handler for map <-> mod which can be used for 
checking what MAA/Cultures are needed plus for future use when people will create their own mappers, with what mods are needed~~
\
